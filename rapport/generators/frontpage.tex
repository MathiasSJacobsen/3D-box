...
\HRule \\[0.5cm]
\begin{Huge}
	\bfseries{Multiway Dataflow Constraint System and UI Programming}\\[0.7cm] % Title of your document
\end{Huge}
\HRule \\[0.5cm]
...
\large \emph{Author:} Mathias Skallerud Jacobsen\\
\large \emph{Supervisors:} Mikhail Barash and Jaakko Järvi\\[2cm]
